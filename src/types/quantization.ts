...
// Lokal aus public/models/ servieren — Kaggle/TFHub setzt keine CORS-Header
// und blockiert den direkten Browser-Fetch.
export const TFLITE_MODEL_URLS: Record<QuantizationLevel, string> = {
  fp32: "/models/movenet-lightning-fp32.tflite",
  fp16: "/models/movenet-lightning-fp16.tflite",
